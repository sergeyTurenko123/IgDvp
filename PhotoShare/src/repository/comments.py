...
#
async def get_comment(comment_id: int, db: Session) -> Comments | None:
    """
...
async def create_comment(body: CommentsBase, user: Users, photo_id: int, db: Session) -> Comments:
    """
...
async def update_comment(comment_id: int, body: CommentsBase, user: Users, db: Session) -> Comments | None:
    """
